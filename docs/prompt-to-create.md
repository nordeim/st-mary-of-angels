...
Now, `git clone https://github.com/nordeim/rothershrine-v2.git` to your local workspace and then meticulously review the repo included `AGENTS.md`, `CLAUDE.md` , `README.md` and `rothershrine-v2_SKILL.md` to have a deep understanding of the codebase design and architecture. Then meticulously plan to use the same codebase design as the foundation to redesign the website for `https://stjoseph-bt.org.sg/` to make the new website for the latter appears as attractive and modern as the website reference design represented by the codebase at repo `https://github.com/nordeim/rothershrine-v2.git`
